...
function renderCalDia(title,area){
  ...
  const evs=eventosDelDia(key);
  const addBar=`<div style="display:flex;gap:8px;justify-content:center;margin-top:12px;">
    <button onclick="openEventoSheet(null)" style="font-size:12px;color:var(--lav);background:var(--lav-light);border:none;padding:6px 14px;border-radius:99px;cursor:pointer;font-weight:700;">+ Evento</button>
