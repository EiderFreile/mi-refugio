...
function renderHoy(){
  ...
  const hoyTareas = allTareas.filter(t => t.hoy || t.date === today);
  ...
  area.innerHTML=`
    ...
    <div class="hoy-section" style="margin-top:16px;"><div class="hoy-progress"><div style="font-size:14px;font-weight:600;">✓ ${hoyTerminadas.length} de ${hoyTareas.length} tareas de hoy</div><div class="hoy-prog-bar"><div class="hoy-prog-fill" style="width:${pct}%;"></div></div><div style="font-size:13px;font-weight:700;color:var(--lav);">${pct}%</div></div></div>
