      ...
      ${enEsperaItems.map(item=>{
        ...
        return `<div class="hoy-task waiting" style="flex-direction:column;align-items:stretch;">
          <div style="display:flex;align-items:center;gap:10px;">
            ...
            <div style="display:flex;gap:3px;flex-shrink:0;" onclick="event.stopPropagation()">
              <button onclick="setTareaStatus('${t.id}','en_espera')" style="padding:2px 5px;border-radius:5px;border:1px solid var(--lav);background:var(--lav-light);font-size:11px;cursor:pointer;">⏳</button>
              <button onclick="setTareaStatus('${t.id}','en_curso')" style="padding:2px 5px;border-radius:5px;border:1px solid var(--border);background:transparent;font-size:11px;cursor:pointer;">🔄</button>
              <button onclick="setTareaStatus('${t.id}','terminada')" style="padding:2px 5px;border-radius:5px;border:1px solid var(--green);background:var(--green-light);font-size:11px;cursor:pointer;">✅</button>
            </div>
          </div>
          ${nextPaso?`
